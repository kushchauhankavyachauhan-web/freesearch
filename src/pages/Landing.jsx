...
const features = [
  {
    icon: '🧠',
    title: 'AI Life Filter',
    desc: 'Paste anything — messages, news, emails. Lifen reads it against your goals and returns only what matters.',
  },
  {
    icon: '🎯',
    title: 'Daily Brief',
    desc: 'Every morning, a concise AI-generated list of 3–5 priorities based on your life profile.',
  },
  {
    icon: '⏳',
    title: 'Deep Work Mode',
    desc: 'Full-screen focus sessions that block distractions and track your deep work time.',
  },
  {
    icon: '📊',
    title: 'Weekly Reports',
    desc: 'See your focus time, habit streaks, and goal progress in beautiful charts.',
  },
];
    ...
    <div className="min-h-screen bg-[#0D0B2A]">
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl">
          ...
          >
            <motion.h1
              className="text-7xl md:text-9xl font-bold tracking-tight mb-4"
            ...
            <motion.p
              ...
              className="text-base text-white/35 mb-12 max-w-lg mx-auto"
            >
              Your AI-powered life filter. Cut through the noise. Focus on what actually moves the needle.
            </motion.p>
            ...
            >
              <Button size="lg" onClick={() => navigate('/signup')} className="glow">
                Start for free
              </Button>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-white/50 text-lg max-w-xl mx-auto">
              Built for people who want to protect their attention and make real progress on what matters.
            </p>
          </motion.div>
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-white/50 mb-8">
              Join thousands reclaiming their focus and living with intention.
            </p>
            <Button size="lg" onClick={() => navigate('/signup')} className="glow">
